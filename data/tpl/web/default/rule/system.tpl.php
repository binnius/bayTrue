		...
		<table class="tb">
			<tr>
				...
				<td>
					...
					<?php  } ?>
					<div>关联关键字：<input type="text" name="welcomekeyword" class="span5" placeholder="可根据关键字直接关联指定的回复规则" autocomplete="off" /></div>
			...
			<tr>
				...
				<td>
					...
					<?php  } ?>
					<div>关联关键字：<input type="text" name="defaultkeyword" class="span5" placeholder="可根据关键字直接关联指定的回复规则" /></div>
