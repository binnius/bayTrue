...
<body>
  ...
  <section id="page-index" class="__page__" style="display: block;">
		...
		<div id="footer_menu" class="footer footer_menu">
            <ul class="clear">
				<li><a  href="<?php  echo  $this->createMobileUrl('wlindex')?>" class="onactive" ><span class="icons icons_1"></span><label>店铺首页</label></a></li>		
                ...
                <li><a href="javascript:void(0);" id="my_menu"><span class="icons icons_5"><label id="num" class="num"><?php  echo intval($totalnum)?></label></span></a></li>
            </ul>
        </div>
</div>
        <script>
